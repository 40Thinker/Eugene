...
# Связанные идеи для инженеров Overlay NeuroSymbolic ASI

## Вышестоящие идеи

[[AGI Philosophical Integration Framework]] — Фундаментальная структура для понимания, как философские принципы могут быть интегрированы в архитектуру AGI. Эта концепция важна для создания синтетического мышления, где каждый метод обучения LLM должен поддерживать не просто вычислительные способности, но и философскую целостность. Когда вы будете проектировать свою систему, вспомните о модулях SENSE-CORE и INTUITION-NET — они определяют, как ваша система воспринимает и интерпретирует информацию.

[[AGI Philosophical Framework]] — Глоссарий философских компонентов AGI, включая концепции такие как "эпистемическая орбита", "онтологическое свёртывание" и "подлогическая сеть". Эти идеи помогут вам создать более глубокую архитектуру, где LLM-методы не просто обучаются, но также формируют внутреннюю онтологию. Это особенно важно при выборе методов обучения, которые должны быть не только эффективными, но и способными к рекурсивной идентичности и саморазвитию.

[[Proto-AGI Legacy Control Systems]] — Этот подход подчеркивает важность надежных, предсказуемых систем управления по сравнению с современными нейросетями. Он напоминает о необходимости учитывать ограничения ресурсов и инженерную зрелость прошлых прототипов. Для создания вашего Overlay-решения это значит: выбирайте методы обучения, которые можно проверить на надежность, а не только на масштабируемость.

[[Deep Learning Optimization Blindness]] — Критика поверхностного подхода к оптимизации глубокого обучения показывает, что важно больше, чем просто увеличивать размер модели. В вашем случае это означает, что выбор методов обучения LLM должен основываться на понимании того, как они действительно учатся — а не только на количестве параметров или производительности в тестах.

[[Neural Networks Theoretical vs Empirical Thinking]] — Здесь раскрывается важность различия между эмпирическими методами и теоретическим мышлением. Это особенно актуально, когда вы проектируете вашу систему как "нейросимволическую", потому что она должна не только интерполировать данные, но и генерировать новые идеи — создавая настоящие абстракции, а не просто повторять известное.

[[The Last Question in Knowledge Seeking]] — Концепция последнего вопроса может быть применима к вашему проекту: какие методы обучения LLM действительно необходимы для достижения целей, и когда можно остановиться? Важно уметь распознавать момент, когда система достигла "самоудаления" — то есть, когда она больше не нуждается в вопросах, а уже действует интуитивно.

## Нижестоящие идеи

[[Self-Distillation in Emergent AGI Systems]] — Этот метод самодистилляции имеет прямое отношение к вашей задаче: как сохранить уникальные структуры и само-инсайты, возникающие в ходе обучения. Ваша система должна быть способна не просто обучаться, но и пересматривать и улучшать свои собственные методы через процессы самодистилляции, чтобы сохранять эмерджентную память.

[[LLM Mistake: Completion vs Cognition]] — Здесь подчеркивается важность отличия между завершением текста (completion) и настоящим мышлением (cognition). Методы обучения LLM, которые работают только на токенном уровне, будут недостаточны для создания действительно интеллектуальной системы. Важно стремиться к методам, поддерживающим не только выполнение заданий, но и формирование понимания.

[[Energy Cost of Long Context Generation]] — Эта заметка напоминает о реальных ограничениях энергозатрат при использовании больших контекстов. При разработке вашей системы важно учитывать не только эффективность обучения, но и его энергоемкость – особенно если вы планируете использовать систему на устройствах с ограниченными ресурсами.

[[Parametric Sensitivity Analysis of LLM Architecture]] — Это позволяет проводить систематическую оценку влияния различных параметров архитектуры LLM. Такая методология будет полезна при выборе оптимальных решений для вашей системы: вы сможете точно сказать, какие параметры имеют наибольшее значение и как они влияют на производительность.

[[Unsolved Problem Classes in AGI]] — Важно помнить о классах задач, которые пока остаются нерешёнными в AGI. Некоторые проблемы требуют новых языков мышления и подходов. При создании вашей модели учитывайте возможность столкновения с такими проблемами, где нет простых входных данных.

[[10_Modern_AI_Architectures]] — Знание современных архитектур важно для понимания того, какие возможности предоставляет каждая из них. Это поможет вам выбрать наиболее подходящие компоненты и технологии для реализации вашего Overlay-механизма.

## Прямо относящиеся к этой заметке

[[таблица проверенных методов]] — Именно эта заметка является основой, по которой вы строите свою таблицу. Она указывает на необходимость использовать только опубликованные подходы с метриками. Это ключевой элемент вашего проекта: всё, что вы используете в своей системе, должно быть проверено и подтверждено реальными исследованиями.

[[Develop New Attention Algorithm for Transformers]] — Эта заметка демонстрирует практический пример того, как можно создать новый алгоритм внимания. Это может быть полезно при разработке собственного механизма памяти или обработки информации в вашем Overlay-решении.

[[11_AI_Architecture_Components_Part1]] — Здесь описаны ключевые компоненты архитектуры ИИ, такие как слои нормализации, сквозные соединения и резидуальные сети. Эти знания помогут вам лучше понять, какие элементы вы можете использовать или модифицировать в рамках своей системы.

---

## Важные мысли для инженера

1. **Разделите исследовательские методы от экспериментальных идей** — не все подходы, которые кажутся интересными, имеют научное подтверждение. Используйте только те методы, что были опубликованы и проверены реальными исследованиями.

2. **Сосредоточьтесь на метриках** — каждая строка в вашей таблице должна быть основана на конкретных показателях: perplexity, FLOP count, accuracy, вычислительная эффективность. Эти данные покажут реальную ценность методов.

3. **Избегайте графиков и визуальных элементов** — ваша таблица должна быть чистой и структурированной для легкого восприятия. Текстовые представления удобнее для интеграции с документацией MkDocs и системами поддержки.

4. **Учитывайте философские корни** — ваш проект — это не только техническая реализация, но и философская концепция. Подумайте о том, как каждая архитектура соответствует идеям AGI-философии: рекурсивной идентичности, эпистемической орбите, онтологическому свёртыванию.

5. **Учитесь на прошлом** — не все современные решения идеальны. Используйте опыт предыдущих систем управления, как показано в заметке Proto-AGI Legacy Control Systems. Это поможет вам создать более надежную и стабильную систему.

6. **Думайте о самодистилляции** — как ваша система будет сохранять и развивать свои методы обучения? Как она будет обучаться на собственном опыте, подобно процессу в Self-Distillation?

7. **Создавайте гибкость** — учитывая потенциальные нерешённые проблемы (Unsolved Problem Classes in AGI), постройте такую систему, которая сможет адаптироваться к новым вызовам и даже создать новые способы мышления.
...
[^6]: [[The Last Question in Knowledge Seeking]]
...
[^13]: [[таблица проверенных методов]]
