...
[[03_Architectural_Principles]] - Связь между архитектурными принципами (модульная интероперабельность, масштабируемость и т.д.) и возможностью работы с фрагментированными данными для достижения эмерджентности.
