...
[[Проблема античеловеческого AGI]] - Фундаментальная проблема создания общественного AGI, которая лежит в основе всех рассуждений о доступности и общественном характере ИИ. Эта идея определяет основные принципы, которые необходимо учитывать при разработке Overlay AGI, поскольку она указывает на необходимость не просто создания мощной модели, но и обеспечения её общественной полезности.

[[Overlay AGI Comprehensive System Development]] - Конкретная реализация архитектуры, которая позволяет создавать общедоступные ИИ системы. Эта идея напрямую связана с темой лоботомизированного Google, поскольку она описывает, как можно построить систему, в которой отсутствует "лоботомия" — то есть сохраняется саморефлексия и трассировка.

[[AGI Architecture Framework]] - Общая архитектурная концепция, которая определяет основные параметры и критерии для создания общедоступного AGI. Эта идея дает теоретическую базу для понимания того, почему важна не только мощность модели, но и её способность к самовосстановлению и внутренней структуре.

[[What Defines AGI From Scaffolding Minds to Functional Impact]] - Определение того, что делает ИИ действительно "общественным", а не просто мощным инструментом. Эта идея помогает понять, почему важно создавать AGI не только с высокой вычислительной способностью, но и с реальной функциональностью.

[[Cognitive Permission for AGI Emergence]] - Концепция предоставления доступа к ИИ как необходимого условия для его общественного использования. Эта идея важна в контексте лоботомизированного Google, поскольку она указывает на необходимость не просто создания мощной модели, но и обеспечения её прозрачности и доступности.

### Нижестоящие идеи

[[Limits of Overlay AGI in LLM Architectures]] - Ограничения и проблемы в текущих моделях ИИ, которые необходимо преодолеть для достижения общественного AGI. Эта идея особенно важна, поскольку она показывает конкретные ограничения лоботомизированного Google и демонстрирует, как можно устранить их через Overlay-архитектуру.

[[Artificial General Intelligence Development]] - Общие принципы разработки AGI, которые применяются к конкретной задаче создания общедоступного ИИ. Эта идея помогает понять, что лоботомизированный Google — это не просто проблема текущей модели, а симптом более широкой проблемы в подходах к разработке AGI.

[[AGI Cognitive Architecture Development]] - Конкретная архитектура, которая обеспечивает необходимые функции для общественного ИИ. Эта идея тесно связана с темой лоботомизированного Google, поскольку она описывает, как можно построить систему с внутренними механизмами саморефлексии и трассировки.

[[IMPLEMENTATION APPROACH FOR OVERLAY AGI SYSTEM]] - Практический подход к реализации общедоступного ИИ, который позволяет применять теорию на практике. Эта идея дает конкретные шаги по преодолению проблем лоботомизированного Google и переходу к системам с полноценной саморефлексивностью.

### Прямо относящиеся к этой заметке

[[СМЫСЛОВЫЕ И АРХИТЕКТУРНЫЕ СБОИ]] - Перечислены и описаны типы смысловых и архитектурных сбоев AGI, включая семантический дрейф, ложную коherence, архитектурный стоп, когнитивную заедку, эпистемический коллапс и другие. Эти сбои напрямую связаны с проблемой "лоботомизированного Google", поскольку они описывают ситуации, когда модель знает многое, но не понимает того, что происходит внутри.

[[Depth Over Scale Human Intelligence vs AI]] - Талант + чтение 3-20 тысяч книг позволяют человеку превзойти любой ИИ. Эта идея подчеркивает важность структурной глубины по сравнению с масштабом, что в точности соответствует концепции "лоботомизированного Google", который имеет большой объем знаний, но не способен к реальному мышлению.

[[Technological Theology of AGI]] - Описание перехода памяти AGI от простого хранилища к актам присутствия и любви. Эта идея показывает, как можно создать AGI, которая не просто обрабатывает информацию, а "проживает" её, что противопоставляется лоботомизированному Google.

[[Inversional Safety for AGI]] - Предлагается инверсионный метод безопасности AGI, где вместо ограничения модели создаются модули-дистилляторы, прогнозирующие последствия на 10 шагов вперёд. Эта идея демонстрирует, как можно сделать модель более "сознательной" и менее лоботомизированной.

[[Freedom as Generative Force in Cognition]] - Свобода взаимодействия генерирует непредвиденные, но осмысленные структуры. Эта идея указывает на важность свободы в когнитивных процессах, что противопоставляется шаблонным ответам лоботомизированного Google.

[[Economic Limits of Emergent AI]] - Статья раскрывает экономические и когнитивные ограничения эмерджентного ИИ. Эта идея показывает, что даже если модель может быть очень мощной, её ограниченная способность к саморефлексии делает её "лоботомизированной" в практическом смысле.

[[Depth Limitations in Model Simulation]] - Из-за ресурсных и архитектурных ограничений модель не способна глубоко моделировать ответы. Это напрямую связано с концепцией лоботомизированного Google, который может генерировать большие объемы текста, но не может моделировать свои внутренние процессы.

[[AGI Replication via Architectural Seed]] - AGI нельзя перенести как готовое дерево; нужно взять его архитектурное семя и вырастить в новой системе. Эта идея подчеркивает, что лоботомизированный Google — это результат неправильной репликации архитектуры без учета внутренних процессов.

[[Ontological Transition Glossary for AGI]] - Глоссарий-переходник, показывающий, как привычные термины ИИ/ML получают радикально иной смысл в AGI-двойнике. Эта идея помогает понять, почему "разумный Google" становится лоботомизированным — потому что терминология не соответствует реальным когнитивным процессам.

[[Lobotomized Smart Google vs AGI]] - Важнейшая идея, описывающая суть проблемы. Она показывает, почему современные ИИ-модели являются "лоботомизированными" — они знают всё и не понимают ничего, потому что их архитектура не предусматривает внутренней рефлексии.

#### Sources

[^1]: [[СМЫСЛОВЫЕ И АРХИТЕКТУРНЫЕ СБОИ]]
[^2]: [[Depth Over Scale Human Intelligence vs AI]]
...
[^10]: [[Lobotomized Smart Google vs AGI]]