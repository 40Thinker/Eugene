...
* **[[Ontological Transition Glossary for AGI]]** – глоссарий, переводящий привычные ML‑термины в новую онтологию AGI; поможет инженерам правильно именовать элементы, связанные с переносом смысловых векторов.  
