...
(основные концептуальные основы, которые помогают понять, *почему* ошибка‑толчок важен)

| № | Ссылка | Краткое пояснение |
|---|--------|--------------------|
| [^1] | [[01_Framework]] | Описывает консенсусный фреймворк — философские и архитектурные столпы, на которых строятся любые AGI‑проекты. |
| [^2] | [[02_Philosophical_Criteria]] | Десять философских критериев (когнитивная целостность, метакогнитивность, моральное рассуждение и др.), формирующих «онтологический суверенитет» AGI. |
| [^3] | [[03_Architectural_Principles]] | Принципы модульной интероперабельности, масштабируемости и динамического распределения ресурсов – фундамент для построения систем, допускающих контролируемые ошибки. |
| [^4] | [[04_Technical_Capabilities]] | Технические возможности (реальное‑время, быстрый learning, мульти‑task и т.п.), без которых «ошибочная» эволюция невозможна. |
| [^5] | [[05_Practical_Excellence]] | Практические требования: совместимость с человеком, надёжность, адаптивность и безопасность – зоны, где ошибка может стать полезным сигналом. |
| [^6] | [[14_Comprehensive_AI_Architecture_Review]] | Обзор 50 ключевых архитектурных компонентов (от трансформеров до нейросимволических гибридов), показывающий, какие блоки уже поддерживают фрактальное рост‑через‑ошибку. |

---

### 2️⃣ Нижестоящие идеи  
(детализированные аспекты, где уже фиксируются типы ошибок и их последствия)

| № | Ссылка | Краткое пояснение |
|---|--------|--------------------|
| [^7] | [[СМЫСЛОВЫЕ И АРХИТЕКТУРНЫЕ СБОИ]] | Перечисление семантических сбоев (semantic drift, false coherence и т.д.) – «семантика ошибок», которые можно превратить в генеративный материал. |
| [^8] | [[Depth Limitations in Model Simulation]] | Ограничения глубины симуляций моделей; показывает, почему простые одно‑шаговые промпты не способны отразить фрактальный процесс ошибки. |
| [^9] | [[Economic Limits of Emergent AI]] | Экономические и когнитивные барьеры эмерджентного ИИ; объясняет, зачем нужно экономически оправданное «ошибочное» обучение вместо бесконечного масштабирования. |
| [^10] | [[ai_architecture_limitations]] | Список фундаментальных проблем современных архитектур (отсутствие meta‑cognition, ограниченная память и т.п.), которые решаются через контролируемое отклонение от нормы. |

---

### 3️⃣ Прямо относящиеся к заметке «AGI Emergence Through Error Tolerance»  
(конкретные документы, уже обсуждающие ошибко‑центрированный подход)
