...
2. **Внутренняя логика и память модели**: используются **ошибки, интуиции, догадки, мета-комментарии**, в том числе те, что не были озвучены.
...
- Изложи мысль **структурно**, без воды, без украшений.
