...
Если да — то мы можем укладывать датасет с ориентацией на генерацию таких структур. И тогда даже очень маленькая модель может быть умной, а часть функций будет вынесена в RAG.
