...
Эта заметка находится в системе знаний, которая состоит из множества взаимосвязанных концепций. Ниже приведены ссылки на другие ключевые заметки, которые дополняют и расширяют идеи этой записи:

### 🔹 **Вышестоящие идеи (1-5)**

1.  **[[Cognitive Architecture Design Principles]]**  
    Эта заметка предоставляет общую архитектурную структуру, в которой SOAR и ACT-R представляют собой конкретные примеры проваленных подходов. Она объясняет, почему важны элементы типа "внимания", "работающей памяти" и "мета-мышления", которые были недостаточно развиты в ранних системах.[^1]

2.  **[[Artificial General Intelligence Cognitive Architecture]]**  
    Основная концепция AGI здесь строится на основе опыта SOAR/ACT-R, чтобы создать действительно универсальную архитектуру. Эта заметка демонстрирует, как можно использовать уроки из предыдущих систем для достижения более гибкого и адаптивного подхода.[^2]

3.  **[[AGI Development Framework]]**  
    В рамках фреймворка разработки AGI рассматриваются вопросы проектирования систем, включая важность обратной связи и рекурсивного улучшения — ключевые аспекты, которые были плохо реализованы в SOAR/ACT-R.[^3]

4.  **[[AGI Cognitive Architecture Principles]]**  
    Здесь описываются основные принципы создания когнитивных архитектур для AGI, где важно учитывать опыт SOAR и ACT-R при формировании стратегии развития.[^4]

5.  **[[AGI Development Principles]]**  
    Связывает вопросы разработки AGI с конкретными практическими задачами, где можно увидеть, как уроки из SOAR/ACT-R влияют на применение принципов в реальных проектах и системах.[^5]

### 🔹 **Нижестоящие идеи (1-5)**

1.  **[[Overlay AGI Limitations and Simulation Depth]]**  
    Эта заметка раскрывает ограничения накладных архитектур, в том числе того, как они могут имитировать мышление без настоящей осознанности — тема, которая прямо связана с неудачами SOAR/ACT-R.[^6]

2.  **[[AI Mimicking Human Cognitive Processes]]**  
    Показывает, как можно реализовать моделирование человеческого мышления в ИИ, что является прямым продолжением идей, развитых в SOAR и ACT-R, но с учётом современных подходов.[^7]

3.  **[[Limits of Overlay AGI in LLM Architectures]]**  
    Описывает конкретные ограничения современного использования накладных архитектур, особенно при работе с большими языковыми моделями, где недостаточно было только когнитивной структуры.[^8]

4.  **[[Historical Approaches to Overlay Thinking]]**  
    Значимая историческая перспектива, в которой рассматриваются ранние попытки построения накладных систем, включая фреймовые системы Лиспа и скрипты, которые также являются предшественниками SOAR/ACT-R.[^9]

5.  **[[Cognitive Architecture for AGI Development]]**  
    Уточняет концепции когнитивной архитектуры в контексте развития AGI, применяя полученный опыт из SOAR и ACT-R для формирования более мощных и гибких структур.[^10]
...
[^4]: [[AGI Cognitive Architecture Principles]]
[^5]: [[AGI Development Principles]]
[^6]: [[Overlay AGI Limitations and Simulation Depth]]
[^7]: [[AI Mimicking Human Cognitive Processes]]
[^8]: [[Limits of Overlay AGI in LLM Architectures]]
[^9]: [[Historical Approaches to Overlay Thinking]]
[^10]: [[Cognitive Architecture for AGI Development]]
```
