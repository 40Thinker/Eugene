...
- [[Z-Network Self-Splitting Cognition]] — Содержит механизмы внутреннего рекурсивного вопросирования, что позволяет реализовать методы "реверсивных запросов" через механизм Z-query сетей [^8].
