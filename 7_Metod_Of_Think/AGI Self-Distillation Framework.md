...
[[AGI Self-Distillation Framework]] — Основная идея. Нужно создавать дистилляторы, которые могут перерабатывать свои собственные ответы в новые структуры, развиваясь по мере взаимодействия с пользователем.
