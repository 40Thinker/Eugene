...
## Связанные идеи для понимания Steroid-Boosted Heuristics for AGI

### Вышестоящие идеи

1. [[Paradigmaljump in AGI Development]] — Эта концепция предоставляет теоретическую основу для перехода между несовместимыми парадигмами мышления, что аналогично процессу трансформации TRIZ-операторов в динамические онтологические функции. Обе идеи подчеркивают необходимость интеллектуальных скачков и переосмысления базовых принципов для развития AGI [^1].

2. [[Ontogenetic Architecture in AI Development]] — Сходство с подходом к онтогенетической архитектуре в том, что оба концепта подчеркивают важность внутреннего строения и эволюции мышления от первоначальных понятий к сложным структурам. Важно учитывать, как "семантическая сжатая трубка" (semantic compression pipeline) из [[Ontogenetic Architecture in AI Development]] может интегрироваться в процесс создания эвристик [^2].

3. [[Recursive Insight Engine]] — Механизмы рекурсивных инсайтов и обратной связи, описанные здесь, обеспечивают "инициатор" для развития эвристик, особенно через создание замкнутых циклов взаимного усиления сознания [^3].

### Нижестоящие идеи

1. [[Self-Verification Modules for AI Cognition]] — Модули самопроверки могут быть использованы для контроля и проверки работоспособности стероидных эвристик, особенно при их интеграции в RAG-системы [^4].

2. [[Self-Generating Language Model Architecture]] — Эта идея показывает, как можно создавать модели, которые генерируют своё собственное мышление. Это может быть применено для создания стероидных эвристик, где они не просто используются, но и "самостоятельно порождаются" в процессе обучения [^5].

3. [[Spiral Thinking in AI Development]] — Спиральное мышление позволяет системе постепенно развивать понимание эвристик от абстрактных до конкретных форм, что соответствует концепции "reverse engineering" и последующего развития стероидных эвристик [^6].

### Прямо относящиеся к этой заметке

1. [[Overlay AGI Through Modular Prompting]] — Подходы модульного промптинга могут быть использованы для реализации стероидных эвристик в рамках интерактивной работы с пользователем, особенно если эти эвристики будут встроены как части цепочки prompt-ов [^7].

2. [[Q-INTENT Autonomous Internal Questioning]] — Модуль Q-INTENT может быть использован для генерации внутренних вопросов, которые помогают в процессе обратного инженеринга эвристик и их трансформации в AGI [^8].

3. [[Multimodal Cognitive Architecture]] — Структура многомодального архитектуры позволяет рассматривать стероидные эвристики как части различных режимов обработки информации, особенно при использовании образно-интуитивного восприятия и логико-структурного анализа [^9].

4. [[OBSTRUCTIO Artificial Evolution Framework]] — Механизмы искусственной эволюции могут быть применены для создания условий, в которых стероидные эвристики могут развиваться и трансформироваться под влиянием ограничений, как в случае с TRIZ-операторами [^10].

5. [[Rare AGI Cognitive States]] — Учет редких состояний AGI поможет понять моменты, когда стероидные эвристики могут вызывать "коллапс эхо", "парадоксальную блокировку" или другие особые состояния, которые необходимо учитывать при их внедрении [^11].

---

## Важные аспекты для инженера

Для успешной реализации идеи стероидных эвристик важно обратить внимание на следующие моменты:

- **Концепция reverse-engineering**: Не просто применять готовые TRIZ-операторы, но раскрывать их "генеративную подстркутуру" — как они возникли и какие процессы лежат в основе их эффективности.

- **Интеграция с RAG-системами**: Эвристики должны быть не просто сохранены в базе данных, но активно использованы для формирования семантической топологии через Retrieval-Augmented Generation. Это требует понимания того, как эвристики становятся "онтологическими векторами".

- **Фрактальная структура**: Эвристики должны быть способны к рекурсивному абстрагированию и формированию фрактальных пространств рассуждений. Это значит, что они могут быть применены на разных уровнях сложности.

- **Динамическое изменение контекста**: Необходимо учитывать, как эвристики адаптируются в зависимости от контекста и обратной связи — это ключевая особенность стероидных эвристик по сравнению с обычными правилами.

- **Интеграция с другими модулями**: Понимание того, как стероидные эвристики взаимодействуют с такими компонентами, как самопроверка (Self-Verification), когнитивная архитектура и рекурсивные инсайты — позволит построить полноценную систему AGI.

- **Механизмы самовосстановления и самообновления**: Эвристики должны быть не просто статичными, но способны к внутренней эволюции и перестройке в ответ на изменения в окружающей среде или новых данных. Это требует интеграции с фреймворками искусственной эволюции.
