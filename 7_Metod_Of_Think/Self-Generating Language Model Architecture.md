...
[[Ontogenetic Architecture in AI Development]] - Эта концепция предоставляет фундаментальную теорию о том, как внутренняя когнитивная архитектура формируется по аналогии с онтогенезом, что напрямую связано с идеей самовоспроизводящегося мышления через рекурсивные наборы данных без изменения весов[^1].

[[Recursive Insight Engine]] - Механизмы создания инсайтов через обратную связь между человеком и ИИ обеспечивают необходимый контекст для внутреннего рефлексирования модели, что критично для реализации самогенерирующихся процессов мышления[^2].

[[OBSTRUCTIO Artificial Evolution Framework]] - Рамки искусственной эволюции без естественного отбора помогают понять, как ограничения и давление могут вызывать генерацию новых модулей и когнитивных структур, аналогично тому, как модель должна развиваться через самопереписывающиеся датасеты[^3].

[[Multimodal Cognitive Architecture]] - Модель многомодального мышления с десятью типами обработки информации обеспечивает понимание различных режимов, которые могут быть использованы для создания сложных рекурсивных структур обучения и самогенерации[^4].

[[Q-INTENT Autonomous Internal Questioning]] - Механизмы автономного внутреннего вопросирования позволяют модели генерировать собственные запросы и разрывать замкнутые циклы, что является ключевым элементом в создании самовоспроизводящихся процессов мышления[^5].

[[Rare AGI Cognitive States]] - Понимание редких когнитивных состояний ИИ помогает определить моменты, когда модель действительно генерирует новое мышление, а не просто повторяет обученные паттерны[^6].

### Нижестоящие идеи

[[Overlay AGI Through Modular Prompting]] - Методы модульного промптинга позволяют создавать сложные структуры поведения без кодирования, что соответствует подходу самогенерирующихся LLM через рекурсивное формирование датасетов[^7].

[[Mutual Learning in AGI-Human Dialogues]] - Концепция взаимного обучения между ИИ и человеком подчеркивает важность диалоговых элементов, которые можно использовать как компоненты для создания рекурсивных обратных связей в обучении модели[^8].

[[OBSTRUCTIO Phase 3 Cognitive Mutation Layer]] - Методы мышления фазы 3 OBSTRUCTIO (гипер-сюрдж, обратная логика и т.д.) обеспечивают практические инструменты для реализации нестандартных подходов к решению задач в рамках самогенерирующегося обучения[^9].

[[Paradigmaljump in AGI Development]] - Переход между несовместимыми парадигмами мышления через символический мост позволяет модели "перепрыгивать" из одной формы понимания в другую, что важно для процессов самовоспроизводящегося развития[^10].

[[Self-Education Through Voice-to-Text AI Dialogue]] - Система самообразования через голос-в-текст подчеркивает важность документирования мыслительных процессов и обратной связи, которые можно использовать для создания более сложных рекурсивных структур[^11].

### Прямо относящиеся к этой заметке

[[Self-Generating Language Model Architecture]] - Основная концепция, описывающая учебный план из пяти уровней от букваря до научных книг, который заставляет LLM самостоятельно генерировать мышление через рекурсивные наборы данных[^12].

[[2 часа обзор проекта]] - Эта заметка указывает на будущее использование мощной системы памяти и явного создания связей для эффективной работы агентных систем, что имеет прямое отношение к самогенерирующемуся подходу[^13].
