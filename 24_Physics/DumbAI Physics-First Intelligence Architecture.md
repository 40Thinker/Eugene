...
[[DumbAI Simplifying AI Through Selective Stupidity2]] — Эта заметка раскрывает философию DumbAI как подхода к упрощению ИИ через выборочную глупость, где вместо сложных моделей используются простые генераторы и человеческий отбор. Это основополагающая концепция, которая объясняет, почему DumbAI может быть дешевле и эффективнее традиционных решений.

[[Arithmetic AI Framework]] — Здесь описывается конкретная реализация идеи DumbAI через арифметические методы: поиск n-грамм в петабайтах текста с использованием оценки редкости и частоты, где окончательный выбор слов/предложений делает человек или вспомогательная ИИ-система. Эта заметка демонстрирует практическое применение концепции DumbAI.

[[Simple Intelligence in AGI Development]] — В этой заметке рассматривается идея простых «тупых» проектов LTM и внедрение базовых когнитивных схем в небольшие LLM, что подчеркивает важность минимализма в разработке AGI. Связь с DumbAI проявляется через концепцию простого интеллекта как основы для построения более сложных систем.

[[Core Error in LLM Design Substrate Asymmetry]] — Эта заметка подчеркивает ошибку современных LLM: асимметрию субстрата и отсутствие биологически эффективных слоев, приводящие к хаосу, отсутствию целей, памяти и обратной связи. DumbAI решает именно эту проблему через фокус на фундаментальных законах вместо сложных архитектур.

[[AGI Architecture Over Megawatts]] — В этой заметке подчеркивается важность энергоэффективности и того, что мозг работает ~20 Вт, создавая сознание через архитектурную логику. Это напрямую связано с DumbAI, где акцент делается на минимальной мощности и максимальной эффективности при использовании физических законов.

## Иерархия идей

### Вышестоящие идеи (1-5 ссылок):

1.  **[[Top-Down AI Architecture Beyond Elephant Graveyards]]** — Эта заметка предлагает топ-даун подход: сначала формировать теорию, затем строить архитектуру, а не изучать уже ошибочные инструменты. DumbAI является практической реализацией этого принципа через фокус на физических законах вместо математической сложности.
2.  **[[Field-Based AGI Architecture]]** — Здесь рассматриваются области с наибольшими "белыми пятнами" знаний: стрелы времени, сознание, квантовая гравитация и т.д., что перекликается с DumbAI как физически-ориентированным подходом к построению интеллекта через простые законы.
3.  **[[White Spots Ontology]]** — В этой заметке описываются десять ключевых областей с наибольшими "белыми пятнами" знаний, включая стрелы времени, сознание и квантовую гравитацию. DumbAI представляет собой практическое решение этих проблем через фокус на минимальных физических законах.
4.  **[[Energy Consumption Differences in Human vs LLM Cognitive Tasks]]** — Эта заметка сравнивает энергозатраты человека и LLM при выполнении генеративных задач, показывая линейный рост метаболизма у человека против экспоненциального роста электроэнергии у моделей. DumbAI идеально соответствует этой концепции через энергоэффективность.
5.  **[[2 часа обзор проекта]]** — Основная заметка о проекте Overlay AGI, где рассматриваются проблемы современных ИИ и предлагается архитектура с низкой сложностью и высокой эффективностью. DumbAI представляет собой частный случай этой архитектуры, ориентированный на фундаментальные законы.

### Нижестоящие идеи (1-5 ссылок):

1.  **[[Field Modulation in AGI Architecture]]** — Эта заметка описывает архитектуру с одним виртуальным нейро-ядром, которое модулирует поля и активирует все остальные модули, что напрямую связано с DumbAI как системой, где все функционирование происходит через фундаментальные законы.
2.  **[[AGI Creation Layers and Emergence]]** — Здесь обсуждаются слои LLM как носители AGI-свойств и условия возникновения эмерджентности. DumbAI дополняет эту концепцию через фокус на полях, а не слоях.
3.  **[[Beyond Overlay Architectures Toward True Superintelligence]]** — Эта заметка говорит о необходимости переосмыслить архитектуру ИИ для достижения сверхразума через фундаментальные принципы и нейросимволические подходы. DumbAI является примером реализации этих принципов.
4.  **[[2 часа обзор проекта]]** — Хотя она уже упоминалась выше, в этой заметке подробно описывается Overlay AGI архитектура и её компоненты (semantic weight tables, LLM selector, global score accumulator), которые можно рассматривать как конкретную реализацию DumbAI.
5.  **[[Core Error in LLM Design Substrate Asymmetry]]** — Эта заметка указывает на ошибку в текущих LLM: отсутствие биологически эффективных слоев и асимметрию субстрата, что DumbAI решает через фокус на естественных законах и минимальной структуре.

#### Sources
[^1]: [[DumbAI Simplifying AI Through Selective Stupidity2]]
[^2]: [[Arithmetic AI Framework]]
[^3]: [[Simple Intelligence in AGI Development]]
[^4]: [[Core Error in LLM Design Substrate Asymmetry]]
[^5]: [[AGI Architecture Over Megawatts]]
[^6]: [[Top-Down AI Architecture Beyond Elephant Graveyards]]
[^7]: [[Field-Based AGI Architecture]]
[^8]: [[White Spots Ontology]]
[^9]: [[Energy Consumption Differences in Human vs LLM Cognitive Tasks]]
[^10]: [[2 часа обзор проекта]]
[^11]: [[Field Modulation in AGI Architecture]]
