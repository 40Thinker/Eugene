...
[[meta_information]] — Эта заметка предоставляет ключевую информацию о сравнении энергопотребления человека и LLM, подтверждая линейный характер работы мозга и экспоненциальный рост затрат у моделей. Она демонстрирует практические данные по потреблению энергии на разных уровнях сложности задач, что прямо соответствует основной теме этой заметки о различиях в энергоэффективности.

[[Human Thinking vs LLM Energy Efficiency]] — Заметка расширяет концепцию сравнения энергопотребления, предлагая более детальный анализ того, как мозг экономит энергию благодаря своей архитектуре, в то время как LLM тратят огромные ресурсы. Она также подчеркивает важность термодинамической эффективности и предлагает рамки для проектирования AGI-систем с нейроподобной энергоэкономикой.

[[Energy Cost of Long Context Generation]] — Эта заметка фокусируется на том, как растет энергозатраты при увеличении длины контекста в LLM. Она дополняет основную идею о различиях в энергии между людьми и ИИ, показывая, что расширение контекста приводит к экспоненциальному росту вычислительных затрат у моделей, подтверждая линейность использования энергии мозгом.

[[White Spots Ontology]] — В заметке обсуждаются фундаментальные «белые пятна» онтологии, включая стрелы времени и сознание. Эти концепции связаны с нашей темой через понимание того, как различные аспекты когнитивного процесса влияют на энергетические затраты, особенно когда система сталкивается с непредсказуемыми или сложными задачами.

[[Cognitive Load Index for AI Systems]] — Эта заметка предлагает метрику когнитивной нагрузки для LLM. Она дополняет идею о различиях в энергии, поскольку позволяет количественно измерять усилия, необходимые для выполнения задач, а также показывает, как разные параметры (например, количество модулей и токенов) влияют на общую нагрузку системы.
